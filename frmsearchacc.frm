...
Begin VB.Form frmsearchacc 
   Caption         =   "Finder Accounts"
   ClientHeight    =   4845
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6945
   Icon            =   "frmsearchacc.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   4845
   ScaleWidth      =   6945
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboCrieria 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   330
         ItemData        =   "frmsearchacc.frx":074C
         Left            =   2280
         List            =   "frmsearchacc.frx":0765
         TabIndex        =   7
         Top             =   360
         Width           =   1455
      End
   ...
   End
End
Attribute VB_Name = "frmsearchacc"
...
If Not cboField.Text = "" Then
    If Not cboCrieria.Text = "" Then
        ...
        sql = "SELECT     AccNo, Name, AccountName, Payno FROM         CUB where " & cboField.Text & "" & cboCrieria.Text & "" & txtFrom.Text & ""
...
Set li = frmsearchacc.lstSearch.ListItems.Add(, , .Fields(0))
        ...
        ElseIf cboCrieria.Text = "Like" Then
         'If cboField.Text = "R_No" Then
            sql = "SELECT     AccNo, Name, AccountName, Payno FROM         CUB ORDER BY Name"
            'Else
            'end if
           CConnect.OpenRS
...
Private Sub Form_Load()
    With frmsearchacc.lstSearch
        .ListItems.Clear
        .ColumnHeaders.Clear
        .ColumnHeaders.Add , , "Account No", 1500
        .ColumnHeaders.Add , , "Account Name", 2800
        .ColumnHeaders.Add , , "Group Name", 2800
        .ColumnHeaders.Add , , "Group Type", 2800
        .View = lvwReport
        .GridLines = True
    End With
    ...
    CConnect.cnnConnect
    sql = "SELECT AccNo, Name, AccountName, Payno FROM CUB ORDER BY AccNo"
    CConnect.OpenRS
    With rs
        If .RecordCount > 0 Then
            .MoveFirst
