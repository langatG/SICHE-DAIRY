...
If Not cboField.Text = "" Then
    If Not cboCrieria.Text = "" Then
        ...
        sql = "SELECT username,UserLoginIDs FROM  UserAccounts where " & cboField.Text & "" & cboCrieria.Text & "" & txtFrom.Text & ""
           ...
           CConnect.OpenRS
            ...
            With rs
                If .RecordCount > 0 Then
                    .MoveFirst
                    Do While Not .EOF
 Set li = frmSearchVendor.lstSearch.ListItems.Add(, , !UserLoginIDs)
        ...
        ElseIf cboCrieria.Text = "Like" Then
         'If cboField.Text = "R_No" Then
            sql = "SELECT username,UserLoginIDs FROM  UserAccounts order by userid"
            'Else
            'end if
           CConnect.OpenRS
            ...
            With rs
                If .RecordCount > 0 Then
                    .MoveFirst
                    Do While Not .EOF
                     If cboField.Text = "UserLoginIDs" Then
                        ...
                        End If
                        If Not .EOF Then
 Set li = frmsearchsearchusers.lstSearch.ListItems.Add(, , !UserLoginIDs)
                li.SubItems(1) = !username & ""
        ...
        Else
            If cboField.Text = "Phone" Then
                sql = "SELECT username,UserLoginIDs FROM  UserAccounts where " & cboField.Text & " " & cboCrieria & " " & txtFrom.Text & " And " & txtTo.Text & ""
               CConnect.OpenRS
            Else
                sql = "SELECT username,UserLoginIDs FROM  UserAccounts where " & cboField.Text & " " & cboCrieria & " '" & txtFrom.Text & "' And '" & txtTo.Text & "'"
               CConnect.OpenRS
...
Set CConnect = New MAZIWA.CConnect
    ...
    CConnect.cnnConnect
    sql = "SELECT username,UserLoginIDs FROM  UserAccounts"
    CConnect.OpenRS
