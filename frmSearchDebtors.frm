...
Begin VB.Form frmSearchDebtors 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboCrieria 
         ...
         Left            =   2280
         List            =   "frmSearchDebtors.frx":0217
         TabIndex        =   3
         Top             =   360
         Width           =   1455
      End
      Begin VB.ComboBox cboField 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   330
         ItemData        =   "frmSearchDebtors.frx":0235
         Left            =   120
         List            =   "frmSearchDebtors.frx":0237
         TabIndex        =   2
         Top             =   360
         Width           =   2055
      End
      Begin VB.CommandButton cmdRef 
         Height          =   495
         Left            =   3840
         Picture         =   "frmSearchDebtors.frx":0239
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Refresh"
         Top             =   4080
...
Private Sub Form_Load()
    With frmSearchDebtors.lstSearch
        .ListItems.Clear
        .ColumnHeaders.Clear
        .ColumnHeaders.Add , , "Debtors Names", 1500
        .ColumnHeaders.Add , , "Debtors Code", 2800
        .View = lvwReport
        .GridLines = True
    End With
