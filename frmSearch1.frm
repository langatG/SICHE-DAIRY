...
Begin VB.Form frmSearch1 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboCrieria 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   330
         ItemData        =   "frmSearch1.frx":0204
         Left            =   2280
         List            =   "frmSearch1.frx":021A
         TabIndex        =   3
         Top             =   360
         Width           =   1455
      End
      Begin VB.ComboBox cboField 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   330
         ItemData        =   "frmSearch1.frx":023B
         Left            =   120
         List            =   "frmSearch1.frx":023D
         TabIndex        =   2
         Text            =   "P_Name"
         Top             =   360
         Width           =   2055
...
If Not cboField.Text = "" Then
    If Not cboCrieria.Text = "" Then
        If Not cboCrieria.Text = "Between" And Not cboCrieria.Text = "Like" Then
            sql = "Select * from d_Outlet where " & cboField.Text & "" & cboCrieria.Text & "'" & txtFrom.Text & "'"
           CConnect.Openrs
            ...
            With rs
                If .RecordCount > 0 Then
                    .MoveFirst
                    Do While Not .EOF
                       Set li = frmSearch1.lstSearch.ListItems.Add(, , !p_code)
        ...
        ElseIf cboCrieria.Text = "Like" Then
            ...
            sql = "Select * from d_Outlet order by P_code"
           CConnect.Openrs
...
Set CConnect = New MAZIWA.CConnect
    ...
    CConnect.cnnConnect
    sql = "Select * from d_Outlet order by P_NAME"
    CConnect.Openrs
