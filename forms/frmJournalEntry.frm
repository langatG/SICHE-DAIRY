...
If optLoanReversal = True Then
        ...
        '//update loanbal
                               ...
                               doc_posted = 0
                               chequeno = DocumentNo
        If Not Save_GLTRANSACTION(Format(dtpLoanTransDate, "DD/MM/YYYY"), CDbl(txtPrincipal), "A007", "L099", DocumentNo, TransSource, User, ErrorMessage, TransDescription, CashBook, doc_posted, chequeno, TransSource, TransSource, TransSource, TransSource) Then
        ...
        End If
                            ...
                            DocumentNo = "RI" & txtLoansVoucherNo & Format(time, "hh:mm:ss")
                               ...
                               doc_posted = 0
                               chequeno = DocumentNo
                If Not Save_GLTRANSACTION(Format(dtpLoanTransDate, "DD/MM/YYYY"), CDbl(txtInterest), "I001", "L099", DocumentNo, TransSource, User, ErrorMessage, TransDescription, CashBook, doc_posted, chequeno, TransSource, TransSource, TransSource, TransSource) Then
            If ErrorMessage <> "" Then
                MsgBox ErrorMessage, vbInformation, Me.Caption
                ErrorMessage = ""
            End If
        ...
        '//addnew item to  contrib
             If Not Save_Contrib(txtShareMemberNo, dtpSharesTransDate, 1000, CDbl(txtSharesTotalAmount) * (-1), _
                ...
                Dim DocumentNo As String, TransSource As String, TransDescription As String, CashBook As Long, doc_posted As Integer, chequeno As String
                               ...
                               doc_posted = 0
                               chequeno = DocumentNo
        If Not Save_GLTRANSACTION(Format(dtpSharesTransDate, "DD/MM/YYYY"), CDbl(txtSharesTotalAmount), "L009", "L099", DocumentNo, TransSource, User, ErrorMessage, TransDescription, CashBook, doc_posted, chequeno, TransSource, TransSource, TransSource, TransSource) Then
            If ErrorMessage <> "" Then
                MsgBox ErrorMessage, vbInformation, Me.Caption
                ErrorMessage = ""
            End If
