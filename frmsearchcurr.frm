...
Begin VB.Form frmsearchcurr 
   Caption         =   "AC- Currency Finder"
   ClientHeight    =   4635
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6915
   Icon            =   "frmsearchcurr.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   4635
   ScaleWidth      =   6915
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   495
         Left            =   3240
         Picture         =   "frmsearchcurr.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Cancel"
         Top             =   4080
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton cmdFind 
            ...
            Height          =   375
            Left            =   2400
            Picture         =   "frmsearchcurr.frx":0544
            Style           =   1  'Graphical
            TabIndex        =   5
            Top             =   240
            Width           =   375
      ...
      Begin VB.ComboBox cboCrieria 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   330
         ItemData        =   "frmsearchcurr.frx":0646
         Left            =   2280
         List            =   "frmsearchcurr.frx":065F
         TabIndex        =   3
         Top             =   360
         Width           =   1455
      End
      ...
      Begin VB.CommandButton cmdRef 
         Height          =   495
         Left            =   3840
         Picture         =   "frmsearchcurr.frx":0683
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Refresh"
         Top             =   4080
   ...
   End
End
Attribute VB_Name = "frmsearchcurr"
...
If Not cboField.Text = "" Then
    If Not cboCrieria.Text = "" Then
        ...
        sql = "SELECT     CurrCode, Description,  rateaganistsource,Symbol FROM         CUrr where " & cboField.Text & "" & cboCrieria.Text & "" & txtFrom.Text & ""
           ...
           CConnect.Openrs
            ...
            With rs
                If .RecordCount > 0 Then
                    .MoveFirst
                    Do While Not .EOF
Set li = frmsearchcurr.lstSearch.ListItems.Add(, , .Fields(0))
        ...
        ElseIf cboCrieria.Text = "Like" Then
         'If cboField.Text = "R_No" Then
            sql = "SELECT     CurrCode, Description,  rateaganistsource,Symbol FROM         CUrr ORDER BY currcode"
            'Else
            'end if
           CConnect.Openrs
...
Set li = frmsearchcurr.lstSearch.ListItems.Add(, , .Fields(0))
        ...
        Else
            If cboField.Text = "RateAganistSource" Then
                sql = "SELECT     CurrCode, Description,  rateaganistsource,Symbol FROM         curr where " & cboField.Text & " " & cboCrieria & " " & txtFrom.Text & " And " & txtTo.Text & ""
               CConnect.Openrs
            Else
                sql = "SELECT     CurrCode, Description,  rateaganistsource,Symbol FROM         curr where " & cboField.Text & " " & cboCrieria & " '" & txtFrom.Text & "' And '" & txtTo.Text & "'"
               CConnect.Openrs
...
Private Sub Form_Load()
    ...
    With frmsearchcurr.lstSearch
        .ListItems.Clear
        .ColumnHeaders.Clear
        .ColumnHeaders.Add , , "Currency Code", 1500
        .ColumnHeaders.Add , , "Description", 2800
        .ColumnHeaders.Add , , "Rate Aganist Source", 2800
        .ColumnHeaders.Add , , "Symbol", 2800
        .View = lvwReport
        .GridLines = True
    End With
    
    With frmsearchacc.cboField
        .AddItem "CurrCode"
        .AddItem "Description"
        .AddItem "RateAganistSource"
        .AddItem "Symbol"
    End With
    Set CConnect = New MAZIWA.cdbase
    CConnect.cnnConnect
    sql = "SELECT     CurrCode, Description,  rateaganistsource,Symbol From Curr"
...
lstSearch.ListItems.Clear
    ...
    CConnect.cnnConnect
 sql = "SELECT     CurrCode, Description,  rateaganistsource,Symbol From Curr order currcode"
    CConnect.Openrs
    ...
    With rs
        If .RecordCount > 0 Then
            .MoveFirst
            Do While Not .EOF
Set li = frmsearchacc.lstSearch.ListItems.Add(, , .Fields(0))
                li.SubItems(1) = .Fields(1) & ""
                li.SubItems(2) = .Fields(2) & ""
                li.SubItems(3) = .Fields(3) & ""
                .MoveNext
