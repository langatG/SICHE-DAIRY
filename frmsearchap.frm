...
Begin VB.Form frmsearchap 
   Caption         =   "AC Search Payables"
   ClientHeight    =   4905
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7095
   Icon            =   "frmsearchap.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   4905
   ScaleWidth      =   7095
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboCrieria 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   330
         ItemData        =   "frmsearchap.frx":0646
         Left            =   2280
         List            =   "frmsearchap.frx":065F
         TabIndex        =   3
         Top             =   360
         Width           =   1455
      End
...
If Not cboField.Text = "" Then
    If Not cboCrieria.Text = "" Then
        ...
        sql = "SELECT     P_No, paidto, p_amount, particulars, p_date, chequeno FROM         AP where " & cboField.Text & "" & cboCrieria.Text & "" & txtFrom.Text & ""
           ...
           CConnect.Openrs
            ...
            With rs
                If .RecordCount > 0 Then
                    .MoveFirst
                    Do While Not .EOF
Set li = frmsearchap.lstSearch.ListItems.Add(, , .Fields(0))
        ...
        ElseIf cboCrieria.Text = "Like" Then
         'If cboField.Text = "R_No" Then
            sql = "SELECT     P_No, paidto, p_amount, particulars, p_date, chequeno FROM         AP ORDER BY p_no"
            'Else
            'end if
           CConnect.Openrs
...
Set li = frmsearchap.lstSearch.ListItems.Add(, , .Fields(0))
        ...
        Else
            If cboField.Text = "P_Amount" Then
                sql = "SELECT     P_No, paidto, p_amount, particulars, p_date, chequeno FROM         AP where " & cboField.Text & " " & cboCrieria & " " & txtFrom.Text & " And " & txtTo.Text & ""
               CConnect.Openrs
            Else
                sql = "SELECT     P_No, paidto, p_amount, particulars, p_date, chequeno FROM         AP where " & cboField.Text & " " & cboCrieria & " '" & txtFrom.Text & "' And '" & txtTo.Text & "'"
               CConnect.Openrs
...
Private Sub Form_Load()
    ...
    With frmsearchap.lstSearch
        .ListItems.Clear
        .ColumnHeaders.Clear
        .ColumnHeaders.Add , , "Payment No", 1500
        .ColumnHeaders.Add , , "Paid To", 2800
        .ColumnHeaders.Add , , "Amount", 2800
        .ColumnHeaders.Add , , "Particulars", 2800
        .ColumnHeaders.Add , , "Payment Date", 2800
        .ColumnHeaders.Add , , "Cheque No", 2800
        
        .View = lvwReport
        .GridLines = True
    End With
    
    With frmsearchap.cboField
        .AddItem "P_No"
        .AddItem "PaidTo"
        .AddItem "P_Amount"
        .AddItem "particulars"
    ...
    CConnect.cnnConnect
    sql = "SELECT     P_No, paidto, p_amount, particulars, p_date, chequeno FROM         AP where posted=0  ORDER BY p_no"
    CConnect.Openrs
