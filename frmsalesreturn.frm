...
'    oSaccoMaster.ExecuteThis (sql)
     sql = ""
    sql = "set dateformat dmy insert into gltransactions(transdate,amount,draccno,craccno,documentno,source,transdescript,auditid,cash,doc_posted) values('" & txtransdate & "'," & Lvwitems.SelectedItem.SubItems(4) & ",'33-302','33-103','" & Lvwitems.SelectedItem & "','" & cboproductname & "' ,'TRANSPORTERS SALES- " & "" & cboproductname & " Return " & "','" & User & "',1,0)"
    oSaccoMaster.ExecuteThis (sql)
    sql = ""
...
'    oSaccoMaster.ExecuteThis (sql)
     sql = ""
    sql = "set dateformat dmy insert into gltransactions(transdate,amount,draccno,craccno,documentno,source,transdescript,auditid,cash,doc_posted) values('" & txtransdate & "'," & Lvwitems.SelectedItem.SubItems(4) & ",'22-02','22-15','" & Lvwitems.SelectedItem & "','" & cboproductname & "' ,'TRANSPORTERS SALES- " & "" & cboproductname & " Return " & "','" & User & "',1,0)"
    oSaccoMaster.ExecuteThis (sql)
    sql = ""
...
'
     ...
     sql = ""
    sql = "set dateformat dmy insert into gltransactions(transdate,amount,draccno,craccno,documentno,source,transdescript,auditid,cash,doc_posted) values('" & txtransdate & "'," & Lvwitems.SelectedItem.SubItems(4) & ",'33-103','33-302','" & Lvwitems.SelectedItem & "','" & cboproductname & "' ,'STATION Sales- " & "" & cboproductname & " Return " & "','" & User & "',1,0)"
    oSaccoMaster.ExecuteThis (sql)
    sql = ""
...
'
     ...
     sql = ""
    sql = "set dateformat dmy insert into gltransactions(transdate,amount,draccno,craccno,documentno,source,transdescript,auditid,cash,doc_posted) values('" & txtransdate & "'," & Lvwitems.SelectedItem.SubItems(4) & ",'22-02','22-15','" & Lvwitems.SelectedItem & "','" & cboproductname & "' ,'STATION Sales- " & "" & cboproductname & " Return" & "','" & User & "',1,0)"
    oSaccoMaster.ExecuteThis (sql)
    sql = ""
...
'//XXXXXXXXXXXXXXX
    sql = ""
    sql = "set dateformat dmy insert into gltransactions(transdate,amount,draccno,craccno,documentno,source,transdescript,auditid,cash,doc_posted) values('" & txtransdate & "'," & Lvwitems.SelectedItem.SubItems(4) & ",'33-302','33-103','" & Lvwitems.SelectedItem & "','" & cboproductname & "' ,'OTHERS CHECK OFF SALES- " & "" & cboproductname & "Return" & "','" & User & "',0,0)"
    oSaccoMaster.ExecuteThis (sql)
...
'//XXXXXXXXXXXXXXX
    sql = ""
    sql = "set dateformat dmy insert into gltransactions(transdate,amount,draccno,craccno,documentno,source,transdescript,auditid,cash,doc_posted) values('" & txtransdate & "'," & Lvwitems.SelectedItem.SubItems(4) & ",'22-02','22-15','" & Lvwitems.SelectedItem & "','" & cboproductname & "' ,'OTHERS CHECK OFF SALES- " & "" & cboproductname & "Return" & "','" & User & "',0,0)"
    oSaccoMaster.ExecuteThis (sql)
...
'\\ save to gl
    ...
    sql = ""
    sql = "set dateformat dmy insert into gltransactions(transdate,amount,draccno,craccno,documentno,source,transdescript,auditid,cash,doc_posted) values('" & txtransdate & "'," & Lvwitems.SelectedItem.SubItems(4) & ",'33-301','33-101','" & Lvwitems.SelectedItem & "','" & cboproductname & "' ,'Cash Sales- " & "" & cboproductname & " Return " & "','" & User & "','1','0')"
    oSaccoMaster.ExecuteThis (sql)
    sql = ""
...
'\\ save to gl
    ...
    sql = ""
    sql = "set dateformat dmy insert into gltransactions(transdate,amount,draccno,craccno,documentno,source,transdescript,auditid,cash,doc_posted) values('" & txtransdate & "'," & Lvwitems.SelectedItem.SubItems(4) & ",'22-01','22-16','" & Lvwitems.SelectedItem & "','" & cboproductname & "' ,'Cash Sales- " & "" & cboproductname & " Return " & "','" & User & "','1','0')"
    oSaccoMaster.ExecuteThis (sql)
    sql = ""
...
'\\ save to gl
    ...
    sql = ""
    sql = "set dateformat dmy insert into gltransactions(transdate,amount,draccno,craccno,documentno,source,transdescript,auditid,cash,doc_posted) values('" & txtransdate & "'," & Lvwitems.SelectedItem.SubItems(4) & ",'33-303','33-102','" & Lvwitems.SelectedItem & "','" & cboproductname & "' ,'MPESA Sales- " & "" & cboproductname & " Return " & "','" & User & "',1,0)"
    oSaccoMaster.ExecuteThis (sql)
    sql = ""
...
'\\ save to gl
    ...
    sql = ""
    sql = "set dateformat dmy insert into gltransactions(transdate,amount,draccno,craccno,documentno,source,transdescript,auditid,cash,doc_posted) values('" & txtransdate & "'," & Lvwitems.SelectedItem.SubItems(4) & ",'22-01','22-16','" & Lvwitems.SelectedItem & "','" & cboproductname & "' ,'MPESA Sales- " & "" & cboproductname & " Return " & "','" & User & "',1,0)"
    oSaccoMaster.ExecuteThis (sql)
    sql = ""
