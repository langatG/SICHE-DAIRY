...
Begin VB.Form frmSearchPTransporter 
   Caption         =   "Search Parent  Transporter"
   ClientHeight    =   4950
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   7245
   Icon            =   "frmSearchTransporter.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   4950
   ScaleWidth      =   7245
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   495
         Left            =   3240
         Picture         =   "frmSearchTransporter.frx":164A
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Cancel"
         Top             =   4080
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton cmdFind 
            ...
            Height          =   375
            Left            =   2400
            Picture         =   "frmSearchTransporter.frx":174C
            Style           =   1  'Graphical
            TabIndex        =   5
            Top             =   240
            Width           =   375
      ...
      Begin VB.ComboBox cboCrieria 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   330
         ItemData        =   "frmSearchTransporter.frx":184E
         Left            =   2280
         List            =   "frmSearchTransporter.frx":1867
         TabIndex        =   3
         Top             =   360
         Width           =   1455
      End
      Begin VB.ComboBox cboField 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   330
         ItemData        =   "frmSearchTransporter.frx":188B
         Left            =   120
         List            =   "frmSearchTransporter.frx":188D
         TabIndex        =   2
         Top             =   360
         Width           =   2055
      End
      Begin VB.CommandButton cmdRef 
         Height          =   495
         Left            =   3840
         Picture         =   "frmSearchTransporter.frx":188F
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Refresh"
         Top             =   4080
   ...
   End
End
Attribute VB_Name = "frmSearchPTransporter"
...
If Not cboField.Text = "" Then
    If Not cboCrieria.Text = "" Then
        ...
        sql = "SELECT     TransCode,TransName,CertNo,Accno FROM   d_Transporters where " & cboField.Text & "" & cboCrieria.Text & "" & txtFrom.Text & " "
           ...
           CConnect.Openrs
            ...
            With rs
                If .RecordCount > 0 Then
                    .MoveFirst
                    Do While Not .EOF
Set li = frmSearchPTransporter.lstSearch.ListItems.Add(, , .Fields(0))
        ...
        ElseIf cboCrieria.Text = "Like" Then
         'If cboField.Text = "R_No" Then
            sql = "SELECT     TransCode,TransName,CertNo,Accno FROM   d_Transporters WHERE " & cboField & " LIKE '%" & txtFrom & "%'  ORDER BY TransName"
            'Else
            'end if
           CConnect.Openrs
...
Private Sub Form_Load()
    With frmSearchPTransporter.lstSearch
        .ListItems.Clear
        .ColumnHeaders.Clear
        ...
        .GridLines = True
    End With
    With frmSearchPTransporter.cboField
        .AddItem "TransCode"
        .AddItem "TransName"
        .AddItem "CertNo"
        .AddItem "Accno"
    ...
    CConnect.cnnConnect
    sql = "SELECT TransCode,TransName,CertNo,accno FROM  d_Transporters ORDER BY TransCode"
    CConnect.Openrs
    With rs
        If .RecordCount > 0 Then
            .MoveFirst
