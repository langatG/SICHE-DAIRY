...
Begin VB.Form frmsearchre 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboCrieria 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   330
         ItemData        =   "frmsearchre.frx":0204
         Left            =   2280
         List            =   "frmsearchre.frx":021D
         TabIndex        =   3
         Top             =   360
         Width           =   1455
      End
...
If Not cboField.Text = "" Then
    If Not cboCrieria.Text = "" Then
        ...
        sql = "Select * from ag_ag_ag_receipts where " & cboField.Text & "" & cboCrieria.Text & "" & txtFrom.Text & ""
           ...
           CConnect.Openrs
            ...
            With rs
                If .RecordCount > 0 Then
                    .MoveFirst
                    Do While Not .EOF
 Set li = frmsearchre.lstSearch.ListItems.Add(, , !r_id)
                li.SubItems(1) = !r_no & ""
        ...
        ElseIf cboCrieria.Text = "Like" Then
         'If cboField.Text = "R_No" Then
            sql = "Select * from ag_ag_ag_receipts order by r_no"
            'Else
            'end if
           CConnect.Openrs
                ...
                If .RecordCount > 0 Then
                    ...
                    Do While Not .EOF
                     If cboField.Text = "R_No" Then
                        ...
                        End If
                        If Not .EOF Then
Set li = frmsearchre.lstSearch.ListItems.Add(, , !r_no)
        ...
        Else
            If cboField.Text = "Amount" Then
                sql = "select * from ag_ag_ag_receipts where " & cboField.Text & " " & cboCrieria & " " & txtFrom.Text & " And " & txtTo.Text & ""
               CConnect.Openrs
            Else
                sql = "select * from ag_ag_ag_receipts where " & cboField.Text & " " & cboCrieria & " '" & txtFrom.Text & "' And '" & txtTo.Text & "'"
               CConnect.Openrs
...
Set CConnect = New MAZIWA.CConnect
    ...
    With frmsearchre.lstSearch
        .ListItems.Clear
        .ColumnHeaders.Clear
        .ColumnHeaders.Add , , "Receipt Id", 1500
        .ColumnHeaders.Add , , "Receipt No", 1500
    ...
    CConnect.cnnConnect
    sql = "Select * from ag_receipts order by r_id"
    CConnect.Openrs
...
lstSearch.ListItems.Clear
    ...
    CConnect.cnnConnect
    sql = "Select * from ag_ag_receipts order by r_no"
    CConnect.Openrs
