...
Begin VB.Form frmSearchTransporter 
   Caption         =   "Search Sub Transporter"
   ClientHeight    =   4950
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   7245
   Icon            =   "frmSearchsubTransporter.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   4950
   ScaleWidth      =   7245
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Height          =   495
         Left            =   3240
         Picture         =   "frmSearchsubTransporter.frx":164A
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Cancel"
         Top             =   4080
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton cmdFind 
            ...
            Height          =   375
            Left            =   2400
            Picture         =   "frmSearchsubTransporter.frx":174C
            Style           =   1  'Graphical
            TabIndex        =   5
            Top             =   240
            Width           =   375
      ...
      Begin VB.ComboBox cboCrieria 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   330
         ItemData        =   "frmSearchsubTransporter.frx":184E
         Left            =   2280
         List            =   "frmSearchsubTransporter.frx":1867
         TabIndex        =   3
         Top             =   360
         Width           =   1455
      End
      Begin VB.ComboBox cboField 
         ...
         ForeColor       =   &H00FF0000&
         Height          =   330
         ItemData        =   "frmSearchsubTransporter.frx":188B
         Left            =   120
         List            =   "frmSearchsubTransporter.frx":188D
         TabIndex        =   2
         Top             =   360
         Width           =   2055
      End
      Begin VB.CommandButton cmdRef 
         Height          =   495
         Left            =   3840
         Picture         =   "frmSearchsubTransporter.frx":188F
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Refresh"
         Top             =   4080
   ...
   End
End
Attribute VB_Name = "frmSearchTransporter"
...
If Not cboField.Text = "" Then
    If Not cboCrieria.Text = "" Then
        ...
        If cboField.Text = "TransName" Then
        sql = "SELECT     TransCode,TransName,CertNo,Accno FROM   d_Transporters where " & cboField.Text & "" & cboCrieria.Text & "" & txtFrom.Text & " and tt=1"
           ...
           CConnect.Openrs
            ...
            With rs
                If .RecordCount > 0 Then
                    .MoveFirst
                    Do While Not .EOF
Set li = frmSearchTransporter.lstSearch.ListItems.Add(, , .Fields(0))
        ...
        ElseIf cboCrieria.Text = "Like" Then
         'If cboField.Text = "R_No" Then
            sql = "SELECT     TransCode,TransName,CertNo,Accno FROM   d_Transporters WHERE " & cboField & " LIKE '%" & txtFrom & "%' and tt=1 ORDER BY TransName"
            'Else
            'end if
           CConnect.Openrs
...
Set li = frmSearchTransporter.lstSearch.ListItems.Add(, , .Fields(0))
        ...
        Else
            If cboField.Text = "Amount" Then
                sql = "SELECT     * FROM         cub where " & cboField.Text & " " & cboCrieria & " " & txtFrom.Text & " And " & txtTo.Text & ""
               CConnect.Openrs
            Else
                sql = "SELECT     * FROM         cub where " & cboField.Text & " " & cboCrieria & " '" & txtFrom.Text & "' And '" & txtTo.Text & "'"
               CConnect.Openrs
...
Private Sub Form_Load()
    With frmSearchTransporter.lstSearch
        .ListItems.Clear
        .ColumnHeaders.Clear
        .ColumnHeaders.Add , , "Trans Code", 1500
        ...
        .GridLines = True
    End With
    With frmSearchTransporter.cboField
        .AddItem "TransCode"
        .AddItem "TransName"
        .AddItem "CertNo"
        .AddItem "Accno"
    ...
    CConnect.cnnConnect
    sql = "SELECT TransCode,TransName,CertNo,accno FROM  d_Transporters where tt=1 ORDER BY TransCode"
    CConnect.Openrs
    With rs
        If .RecordCount > 0 Then
            .MoveFirst
...
lstSearch.ListItems.Clear
    ...
    CConnect.cnnConnect
   sql = "SELECT     TransCode,TransName,CertNo,Accno FROM   d_Transporters ORDER BY TransName"
    CConnect.Openrs
